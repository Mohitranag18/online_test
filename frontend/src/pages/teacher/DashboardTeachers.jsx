...
const DashboardTeachers = () => {
    ...
    const courses = [
        ...
        { title: 'Advanced Chemistry', questions: 20, completions: 35, rate: 82 },
        { title: 'Physics Fundamentals', questions: 18, completions: 30, rate: 76 },
        { title: 'Mathematics 101', questions: 25, completions: 40, rate: 88 },
    ];
            ...
            <main className="flex-1 w-full lg:w-auto">
                ...
                <div className="p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 mb-6 lg:mb-8">
                        {/* Recent Events - Takes 2 columns on large screens */}
                                ...
                                {recentEvents.map((event, index) => (
                                    <div key={index} className="card p-4 sm:p-5 rounded-xl">
                                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                                            ...
                                            {event.isLive ? (
                                                <button className="w-full sm:w-auto bg-blue-600 px-4 sm:px-5 py-2 rounded-lg text-xs sm:text-sm font-semibold hover:bg-blue-700 transition whitespace-nowrap">
                                                    View Live
                                                </button>
                                            ) : (
                    ...
                    <div className="card-strong p-5 sm:p-6 rounded-2xl">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                            {courses.map((course, index) => (
                                <div key={index} className="card p-4 sm:p-5 rounded-xl hover:scale-[1.02] transition-all duration-200">
                                    <div className="flex justify-between items-start mb-3 sm:mb-4">
                                        <h3 className="font-bold text-sm sm:text-base flex-1 pr-2 line-clamp-2">{course.title}</h3>
                                        <button className="border border-[var(--border-color)] px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs font-medium hover:bg-[var(--input-bg)] transition flex items-center gap-1 whitespace-nowrap">
                                            Manage
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full bg-white/10 rounded-full h-2">
                                            <div className="h-2 rounded-full bg-cyan-500" style={{ width: `${course.rate}%` }}></div>
                                        </div>
                                    </div>
                                </div>
                            ))}
